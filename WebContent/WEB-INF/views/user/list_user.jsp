...
oTBExample2 = $("#tDataTable").DataTable({
	"procesing" : true,
	"serverSide" : true,
	"dom" : '<"H"<"pull-left tInfo"lr>r<"pull-right"T>>t<"F"<"pull-left"i>p>',
	"jQueryUI" : true,
	"paginate" : true,
	"sort" : false,
	"info" : true,
						...
						<form id="searchMandateForm">
							...
							<div class="col-md-12">
								<div class="pull-right form-group">
									...
									<a  class="editor_create btn btn-info btn-sm"> <i
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 id="modal-header-name">Create New User</h3>
			</div>
			<c:url var="approveUrl" value="/bank/user/add" />


			<div class="modal-body">
				<div id="responseMessage"></div>
				<form:form method="POST" commandName="user" action="${action_form}"
					modelAttribute="user">
